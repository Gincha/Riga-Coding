...
private static void uzdevums24() {
	...
	for(int i=0; i<garums; i++) {
		...
		if (char1.isDigit(1) || char1.isDigit(2) ||char1.isDigit(3) || char1.isDigit(4) || char1.isDigit(5) || char1.isDigit(6) || char1.isDigit(7) ||char1.isDigit(8) || char1.isDigit(9) || char1.isDigit(0) ) {			
		 irCipari = true; 
		}
	}
